...
INSTANCES = [
    ...
    },
    {
        ...
        "scalping_experimental_force_entries": os.getenv("V2_SCALPING_EXPERIMENTAL_FORCE_ENTRIES", "0"),
        "scalping_ignore_risk_filters": os.getenv("V2_SCALPING_IGNORE_RISK_FILTERS", "0"),
        "scalping_disable_ai_gate": os.getenv("V2_SCALPING_DISABLE_AI_GATE", "0"),
        "scalping_disable_cooldown": os.getenv("V2_SCALPING_DISABLE_COOLDOWN", "0"),
